...
# проверка на то, что гость видит товары, добавленные в корзину, хотя не добовлял их
...
# проверка на то, что гость не видит сообщение о пустой корзине, хотя должен видеть
@pytest.mark.xfail(reason="Negative test")
